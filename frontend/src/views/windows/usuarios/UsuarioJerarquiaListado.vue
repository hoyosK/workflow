        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                <CCardHeader>
                    ...
                    <button @click="$router.push('/usuarios/jerarquia/edit/0')" class="btn btn-primary float-end">Crear nueva jerarquía</button>
                </CCardHeader>
                <CCardBody>
                    <div>
                        <div class="mb-3">
...
export default {
    ...
    data() {
        return {
            ...
            searchValue: '',
            headers: [
                {text: "Nombre de jerarquía", value: "nombre"},
    ...
    methods: {
        getItems() {
            ...
            const self = this;
            toolbox.doAjax('GET', 'users/jerarquia/list', {},
                function (response) {
        ...
        deleteItem(item) {
            const self = this;
            toolbox.confirm('Se eliminará esta jerarquía de usuarios, ¿desea continuar?', function () {
                toolbox.doAjax('POST', 'users/jerarquia/delete', {
                        id: item.id,
                    },
                    function (response) {
        ...
        editItem(item) {
            this.$router.push('/usuarios/jerarquia/edit/' + item.id);
        }
    }
}
</script>
