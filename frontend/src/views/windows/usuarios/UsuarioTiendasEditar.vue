                ...
                <CCardBody>
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="mb-3">
                                <div v-if="imagen">
                                    <CCardImage :src="imagen" rounded thumbnail orientation="top" style="max-width: 200px"/>
                                    <hr>
                                </div>
                        ...
                        <!-- <div class="col-12 col-sm-6">
                            <div class="mb-3">
                                <div v-if="cintillo">
                                    <CCardImage :src="cintillo" rounded thumbnail orientation="top" style="max-width: 200px"/>
                                    <hr>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <multiselect
                                    ...
                                    :mode="'tags'"
                                    :searchable="true"/>
&lt;!&ndash;                                <select class="form-select" v-model="roles">
...
export default {
    ...
    methods: {
            ...
            toolbox.doAjax('GET', 'users/role/list', {},
                function (response) {
                    ...
                    if (self.id > 0) {
                        ...
                        toolbox.doAjax('GET', 'users/tiendas/get/' + self.id, {},
                            function (response) {
        ...
        guardar() {
            ...
            if (!errors) {
                toolbox.doAjax('POST', 'users/tiendas/save', data,
                    function (response) {
                        toolbox.alert(response.msg, 'success');
                        self.$router.push('/usuarios/tiendas');
                        /*if (self.id === 0) {
