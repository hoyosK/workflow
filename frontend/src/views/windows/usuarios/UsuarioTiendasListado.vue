        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                <CCardHeader>
                    ...
                    <button @click="$router.push('/usuarios/tiendas/edit/0')" class="btn btn-primary float-end">Crear nueva tienda o agencia</button>
                </CCardHeader>
                <CCardBody>
                    <div>
                        <div class="mb-3">
...
export default {
    ...
    methods: {
        ...
        deleteItem(item) {
            const self = this;
            toolbox.confirm('Se eliminará esta tienda, ¿desea continuar?', function () {
                toolbox.doAjax('POST', 'users/tiendas/delete', {
                        id: item.id,
                    },
                    function (response) {
        ...
        editItem(item) {
            this.$router.push('/usuarios/tiendas/edit/' + item.id);
        }
    }
}
</script>
