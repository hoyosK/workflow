<template>
    <div class="card">
        <div class="card-header">
            ...
            <h2 class="mb-4" v-if="page.id !== 0">Editando página de ayuda</h2>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-12 pt-2">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <a :href="'#/ayuda/' + page.slug" class="btn btn-primary" target="_blank"><i class="fas fa-external-link me-2"></i>Ver nota</a>
                    </div>
                </div>
                <div class="form-group col-12 col-md-6 pt-2">
                    <div class="mb-3">
        ...
        <div class="card-footer text-end">
            <button @click="$router.push('/admin/ayuda/list')" class="btn btn-danger me-2">Cancelar</button>
...
export default {
    ...
    methods: {
        ...
        handleFileUpload(fieldName, file, metadata, load, error, progress, abort, page) {
            ...
            const url = (this.page.id !== 0) ? 'paginas-ayuda/new/edit/' + this.page.id : 'paginas-ayuda/new/edit';
        ...
        getItem() {
            ...
            const self = this;
            toolbox.doAjax('GET', 'paginas-ayuda/by/'+self.page.id, {},
                function (response) {
                    if (response.data.id !== null) {
        ...
        guardarBlog() {
            const self = this;
            if(self.page.id === 0){
                toolbox.confirm('Esta noticia se publicará automáticamente en el apartado de ayuda del sitio', function () {
                    //self.selected.id = idCliente;
                    toolbox.doAjax('POST', 'paginas-ayuda/new/edit', self.page, function (response) {
                ...
                //self.selected.id = idCliente;
                toolbox.doAjax('PUT', 'paginas-ayuda/editar/'+self.page.id, self.page, function (response) {
                    toolbox.alert(response.msg);
                    //loadProduct()
                }, function (response) {
                    toolbox.alert(response.msg);
