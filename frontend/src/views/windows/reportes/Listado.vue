        ...
        <CCol :xs="12">
            <CCard class="mb-4">
                <CCardHeader>
                    ...
                    <button @click="$router.push('/reportes/configuracion/0')" class="btn btn-primary float-end">Crear nuevo reporte</button>
                </CCardHeader>
                <CCardBody>
                    <div>
                        <div class="mb-3">
...
export default {
    ...
    methods: {
        getItems() {
            ...
            const self = this;
            toolbox.doAjax('GET', 'reportes/listado/all', {},
                function (response) {
        ...
        deleteItem(item) {
            ...
            toolbox.confirm('Se eliminará este distribuidor, ¿desea continuar?', function () {
                toolbox.doAjax('POST', 'reportes/eliminar', {
                        id: item.id,
                    },
                    function (response) {
                        toolbox.alert(response.msg, 'success');
        ...
        editItem(item) {
            this.$router.push('/reportes/configuracion/' + item.id);
        }
    }
}
</script>
